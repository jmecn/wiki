= jMonkeyEngine 3 教程 (4) - 主循环
:author: (翻译 jmecn)
:revnumber:
:revdate: 2018/01/22 16:41
...
上一篇: <<beginner/hello_asset#,加载资产>>,
下一篇: <<beginner/hello_input_system#,输入响应>>
...
Look back at the <<beginner/hello_node#,Hello Node>> tutorial if you do not remember the transformation methods for scaling, translating, and rotating.


[IMPORTANT]
====
Link to user-proposed solutions: <<beginner/solutions#,Some proposed solutions>> +
...
The next thing the game needs is some __inter__action! Continue learning how to <<beginner/hello_input_system#,响应用户输入>>.
