= jMonkeyEngine 3 教程 (8) - 鼠标拣选
:author: (翻译 jmecn)
:revnumber:
:revdate: 2018/01/22 16:51
...
上一篇: <<beginner/hello_animation#,骨骼动画>>,
下一篇: <<beginner/hello_collision#,碰撞检测>>
...
This tutorial relies on what you have learned in the <<beginner/hello_input_system#,输入响应>> tutorial. You find more related code samples under <<jme3/advanced/mouse_picking#,Mouse Picking>> and <<jme3/advanced/collision_and_intersection#,Collision and Intersection>>.
...
[IMPORTANT]
====
Link to user-proposed solutions: <<beginner/solutions#,jm3:solutions>> +
...
Now, wouldn't it be nice if those targets and the floor were solid objects and you could walk around between them? Let's continue to learn about <<beginner/hello_collision#,碰撞检测>>.

'''

See also:

*  <<beginner/hello_input_system#,输入响应>>
