= jMonkeyEngine 3 教程 (10) - 地形
:author: (翻译 jmecn)
:revnumber:
:revdate: 2018/01/22 16:54
...
上一篇: <<beginner/hello_collision#,碰撞检测>>,
下一篇: <<beginner/hello_audio#,三维音效>>
...
Can you combine what you learned here and in <<beginner/hello_collision#,碰撞检测>>, and <<jme3/advanced/terrain_collision#,make the terrain solid>>?
...
Do you want to hear your players say '`ouch!`' when they bump into a wall or fall off a hill? Continue with learning <<beginner/hello_audio#,添加三维音效>> to your game.
